...
def main():
    ...
    while True:
        ...
        #frame_gray[10:15, :] = 255  # Barra blanca para mejorar visibilidad del texto 
        #frame_gray = frame_gray[:, -1::-1]  # Asegurar que el frame tenga el ancho correcto
        #cv2.imshow("Adquisicion de Video", frame_gray)
